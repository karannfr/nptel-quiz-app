      ...
      <h2 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight ">
        ...
        <div className="flex items-center justify-center w-64 sm:w-75 mt-10 cursor-pointer relative z-20">
            <label
              ...
              className="flex flex-col items-center justify-center w-full h-64 border-2 border-[#b19eef] border-dashed rounded-lg cursor-pointer bg-transparent dark:bg-transparent hover:bg-[#b19eef3f]"
            >
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <svg
                  className="w-8 h-8 mb-4 text-[#b19eef]"
                  aria-hidden="true"
                ...
                <p className="mb-2 text-sm text-[#b19eef]">
                  <span className="font-semibold">Click to upload</span> or drag and drop
                </p>
                <p className="text-xs text-[#b19eef]">PDF, TXT</p>
                {file ? (
                  <p className="text-lg text-green-300 mt-6">{file.name}</p>
                ) : (
                  ""
                )}
                <input
                  id="dropzone-file"
                  type="file"
                  className="text-[#b19eef] w-1/2 hidden"
                  accept=".pdf,.txt"
