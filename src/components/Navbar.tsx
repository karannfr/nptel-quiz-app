...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-row justify-between items-center text-lg text-white max-w-6xl mx-auto sticky sm:top-8 z-[10000] px-8 rounded-4xl sm:border border-[#392e4e] sm:bg-black/50 shadow-lg ring-1 ring-black/5 backdrop-blur-sm py-4">
